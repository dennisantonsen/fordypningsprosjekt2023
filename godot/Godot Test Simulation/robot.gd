...
#Location of the JSON file where the optimal inspection points should be saved to. The results will be extended to the template file, so keep in mind if there are existing inspections in the template
